          ...
          <div className="mt-10 grid grid-cols-1 gap-10 md:grid-cols-2">
            {birokrasiMembers.map((person, index) => (
              <ScrollReveal
                ...
                className="h-full"
              >
                <article className="flex h-full flex-col items-center gap-5 rounded-2xl bg-white/5 p-4 md:flex-row md:items-start md:gap-7 md:rounded-none md:bg-transparent md:p-0">
